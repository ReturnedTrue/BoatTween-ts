...
declare type BoatTweenDataDirection = "In" | "Out" | "InOut" | "OutIn";
...
declare type BoatTweenDataStep = "RenderStepped" | "Stepped" | "Heartbeat";

export declare interface BoatTweenData<T extends Instance> {
	/**
